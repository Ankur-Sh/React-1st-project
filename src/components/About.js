                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body" style={myStyle}>
                            ...
                            statistics for a given text. Textutils reorts the
                            number of words and character. Thus it is suitable
                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body" style={myStyle}>
                            ...
                            Opera. It suits to count characters n facebook,
                            blog, books, excel document, essays, etc.
                        </div>
                    </div>
                </div>
            </div>
